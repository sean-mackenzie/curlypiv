...
# --- Load file paths ---
dirPath = '/Users/mackenzie/Desktop/BPE-ICEO/06.11.21 - BPE-ICEO 500 um/chip1 - 160nm yellow'
gridPath = None
flatfieldPath = None
...
v_max = 5
piv_init_frame = 1
backSub_init_frames = 0
piv_num_analysis_frames = 495
...
# physical
fluoro_particles = fluorescent_particles(diameter=160e-9, concentration=2e-5, materials=polystyrene, electrophoretic_mobility=-9e-8)    # Needs to be measured. I used 3X the 800 nm particles.
...
emccd = ccd(exposure_time=.040, img_acq_rate=24.83, EM_gain=8, darkfield=darkfield)
...
bpespecs = {
    ...
    'bxmax': 425,
    'bymin': 10,
    'bymax': 350,  # y = 0 is the bottom of the image
    'multiplier': 1.0
}
cropspecs = {
    ...
    'xmax': 463,
    'ymin': 0,
    'ymax': 376  # y = 0 is the bottom of the image
}
filterspecs = {
