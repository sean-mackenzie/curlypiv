...
# --- Load file paths ---
dirPath = '/Users/mackenzie/Desktop/05.24.21-bpeiceo-bareAu'
gridPath = None
flatfieldPath = None
darkfieldPath = join(dirPath, 'setup/calibration/cameraNoise/darkfield/darkfield.tif')
iceoStatsPath = '/Users/mackenzie/Desktop/05.24-21-bpeiceo-bareAu/results/iceo-stats/iceo-stats.csv'
iceoMergeStatsPath = '/Users/mackenzie/Desktop/05.24-21-bpeiceo-bareAu/results/iceo-stats/iceo-merge-stats.csv'
load_files = True
...
#no_dielectric = material_solid(name='SiO2', zeta=-0.08, permittivity=4.6, index_of_refraction=1.5, conductivity=1e-18, thickness=3e-9, youngs_modulus=71.7e9, poissons_ratio=0.17, density=2.203e3, dielectric_strength=470e6, Ka=6, reaction_site_density=5)          # Ref: 2/13/21, ZuPIV of SiO2 w/ 100 uM KCl
...
bpe_iceo_channel = channel(length=20e-3, width=500e-6, height=39.0e-6, material_wall_surface=sio2_channel, material_fluid=kcl)                # Ref: 3/11/21, NCF Dektak of PDMS channel height
bpe_iceo_bpe = bpe(length=250e-6, width=500e-6, height=20e-9, material=gold_bpe, adhesion_material=alkane_thiol, dielectric_coating=None)                            # Ref: 4/6/21, Brightfield BPE images + NCF Dektak
...
emccd = ccd(exposure_time=.040, img_acq_rate=24.83, EM_gain=10, darkfield=darkfield)
...
bpespecs = {
    ...
    'bxmin': 40,  # x = 0 is the left of the image
    'bxmax': 431,
    'bymin': 10,
    'bymax': 500,  # y = 0 is the bottom of the image
    'multiplier': 2.0
}
cropspecs = {
