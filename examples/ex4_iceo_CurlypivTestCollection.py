...
bpe_iceo_channel = channel(length=20e-3, width=500e-6, height=39.0e-6, material_bottom_wall_surface=sio2_channel, material_top_wall_surface=pdms_channel, material_fluid=kcl)                # Ref: 3/11/21, NCF Dektak of PDMS channel height
...
testCol = CurlypivTestCollection(collectionName=name, dirpath=dirPath, file_type=img_type, testid=testid,
                                 runid=runid, seqid=seqid, frameid=frameid, load_files=load_files,
