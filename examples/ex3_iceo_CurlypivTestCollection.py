...
bpe_iceo_channel = channel(length=20e-3, width=500e-6, height=16.5e-6, material_bottom_wall_surface=sio2_channel, material_fluid=kcl)                # Ref: 3/11/21, NCF Dektak of PDMS channel height
