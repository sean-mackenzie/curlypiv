...
import curlypiv.utils.calculate_ICEO as iceo
...
# geometry
channel_height = 15e-6          # m         channel height
channel_width = 500e-6          # m         channel width
A = channel_width*channel_width # m2        channel cross sectional area
L = 20e-3                       # m         channel length
L_bpe = 100e-6                  # m         BPE length
...
dielectric_thickness = 5e-9     # m         ALD SiO2 thickness
...
R_0 = iceo.calc_bulk_charge_transfer_resistance(characteristic_length=L_bpe, sigma=sigma)
...
print("Ohmic relaxation time: {}".format())
